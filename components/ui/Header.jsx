  ...
  return (
    <div className='flex justify-between items-center bg-secondary shadow-sm p-4'>
      ...
      <ul className='hidden md:flex gap-6'>
        ...
        <li className={`${menuItemStyle} ${path === '/interviews'&&'text-primary font-semibold'}`}>Interviews</li>
        <li className={`${menuItemStyle} ${path === '/jobs'&&'text-primary font-semibold'}`}>Jobs</li>
